...
class Leave:
    def apply_leave(self, employee_id, start_date, end_date, available_leaves):
        ...
        status='waiting'
        leave_details = [employee_id, start_date, end_date,applied_date,available_leaves,status]
...
employee_leave.apply_leave(555,'2000-09-02','2000-09-02',6)
employee_leave.update_status( 106, 'waiting')
